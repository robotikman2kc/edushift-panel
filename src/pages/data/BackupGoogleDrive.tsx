...
import { Save, Cloud, AlertCircle, CheckCircle, Upload, FileText, Calendar, BookOpen } from "lucide-react";
        ...
        <TabsContent value="panduan" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Ikuti 5 langkah berikut untuk setup backup
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-3">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <p className="font-medium">Copy Script</p>
...
function doPost(e) {
  try {
    ...
    var folderId = 'FOLDER_ID_ANDA'; // Ganti dengan ID folder Drive
  ...
  return output;
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Buka folder Google Drive, copy ID dari URL (setelah /folders/)
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <p className="font-medium">Deploy Web App</p>
                    <ul className="text-sm text-muted-foreground space-y-1 mt-1 ml-4 list-disc">
                      <li>Klik Deploy → <strong>New deployment</strong></li>
                    ...
                    <div className="mt-2 p-3 bg-yellow-500/10 border border-yellow-500/20 rounded-md">
                      <p className="text-sm font-medium text-yellow-700 dark:text-yellow-400">
                        ⚠️ Setiap update script, WAJIB buat <strong>New deployment</strong> baru!
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Copy Web app URL dan paste di tab Konfigurasi
                    </p>
                  </div>
                </div>
              </div>
